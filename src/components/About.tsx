  ...
  const features = [
    {
      ...
      description: "Produtos locais e sazonais, cuidadosamente selecionados todos os dias."
    },
    {
      icon: Heart,
      title: "Feito com Amor",
      description: "Cada prato é preparado com paixão e atenção aos detalhes."
    },
    {
      icon: Star,
      title: "Experiência Única",
      description: "Um ambiente acolhedor para momentos especiais com quem amas."
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-background rounded-2xl p-6 shadow-xl border border-border">
                <div className="text-center">
                  <span className="block text-4xl font-serif font-bold text-cappuccino">5+</span>
                  <span className="text-sm text-muted-foreground">Anos de Sabor</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:pl-8">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                Nascido da paixão por brunches memoráveis, o Cappuccino Brunch é mais do que 
                um restaurante — é um refúgio para os amantes de boa comida e bons momentos.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-10">
                Acreditamos que cada refeição deve ser uma celebração. Por isso, combinamos 
                ingredientes frescos com técnicas criativas para criar pratos que são tão 
                bonitos quanto deliciosos. Do nosso café de especialidade às nossas panquecas 
                fluffy, cada detalhe é pensado para te fazer sorrir.
              </p>
