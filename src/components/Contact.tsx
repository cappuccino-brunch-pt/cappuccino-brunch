          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-lg mb-10">
                Estamos sempre prontos para te receber. Reserva a tua mesa ou 
                simplesmente aparece — há sempre espaço para mais um café!
              </p>
              ...
              <div className="flex items-center gap-4">
                <span className="text-sm text-muted-foreground">Segue-nos:</span>
                <a
            ...
            <div className="bg-card rounded-3xl p-8 border border-border shadow-sm">
              ...
              <p className="text-muted-foreground mb-8">
                Tens alguma questão ou queres fazer uma reserva especial?
              </p>
